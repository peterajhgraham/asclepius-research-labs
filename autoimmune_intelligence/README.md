...
A production-ready full-stack AI web app for autoimmune disease research.
...
Returns `{ "status": "healthy", "service": "Autoimmune Intelligence" }`.
...
|-----------------|---------------------------|---------------------------------|
| `APP_NAME`      | `Autoimmune Intelligence` | Service display name            |
